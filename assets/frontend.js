...
/***/ "./src/js/components/LucydModal.ts":
/*!*****************************************!*\
  !*** ./src/js/components/LucydModal.ts ***!
  \*****************************************/
...
/* harmony export */   LucydModal: () => (/* binding */ LucydModal),
/* harmony export */   createLucydModal: () => (/* binding */ createLucydModal)
/* harmony export */ });
...
// =============================================================================
// Lucyd Modal Component - TypeScript Example
// =============================================================================
var LucydModal = /*#__PURE__*/function () {
  function LucydModal(element, options) {
    _classCallCheck(this, LucydModal);
    this.isOpen = false;
    this.trigger = null;
    this.modal = null;
  ...
  return _createClass(LucydModal, [{
    key: "init",
    value: function init() {
...
function createLucydModal(element, options) {
  return new LucydModal(element, options);
}
...
/* harmony import */ var _sections_lucyd_header_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sections/lucyd-header.js */ "./src/js/sections/lucyd-header.js");
...
window.jQuery = window.$ = (jquery__WEBPACK_IMPORTED_MODULE_3___default());

window.Noty = (noty__WEBPACK_IMPORTED_MODULE_4___default());
// Sections
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var LucydFaqs = /*#__PURE__*/_createClass(function LucydFaqs(container) {
  _classCallCheck(this, LucydFaqs);
...
if (window.Shopify && window.Shopify.designMode) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var faqsSection = document.querySelector('.lucyd-faqs');
    if (faqsSection) {
...
/***/ "./src/js/sections/lucyd-header.js":
/*!*****************************************!*\
  !*** ./src/js/sections/lucyd-header.js ***!
  \*****************************************/
/***/ (() => {
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var LucydHeader = /*#__PURE__*/function () {
  function LucydHeader() {
    _classCallCheck(this, LucydHeader);
    this.$header = document.querySelector('header');
    if (this.$header) {
      this.init();
    }
  }
  return _createClass(LucydHeader, [{
    key: "init",
    value: function init() {
...
/***/ "./src/js/snippets/lucyd-product-card.js":
/*!***********************************************!*\
  !*** ./src/js/snippets/lucyd-product-card.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ProductCard = function ProductCard(sel) {
  var _this2 = this;
  // objet
  var _ = this;
  ...
  this.init = function () {
    ...
    if (_.productCards) {
      _.productCards.forEach(function (item, index) {
        _this.setupForm(item);
      });
    } else {
      console.log('Product cards: NO cards in page');
    }
  };
  this.setupForm = function (card) {
    var id = card.getAttribute('id');
    var form = card.querySelector("form");
    form.addEventListener('change', onVariantChange.bind(_this2));
    ...
    function updateVariant() {
      var selectedVariant = getCurrentVariant();
    ...
    function updatePrice() {
      var selectedVariant = getCurrentVariant();
      if (!selectedVariant) return;
      var regularPriceEl = card.querySelector('[data-regular-price]');
      var salePriceEl = card.querySelector('[data-sale-price]');
...
var productCard = new ProductCard('.product-card');
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var LucydProductTemplate = /*#__PURE__*/function () {
  function LucydProductTemplate() {
    _classCallCheck(this, LucydProductTemplate);
    this.$product = document.querySelector('.template-product');
    if (this.$product) {
      this.init();
    }
  }
  return _createClass(LucydProductTemplate, [{
    key: "init",
    value: function init() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcodeinpsire"] = self["webpackChunkcodeinpsire"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["frontend-vendor.min","frontend.min"], () => (__webpack_require__("./src/js/frontend.ts")))
/******/ 	__webpack_require__.O(undefined, ["frontend-vendor.min","frontend.min"], () => (__webpack_require__("./src/scss/frontend.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["frontend-vendor.min","frontend.min"], () => (__webpack_require__("./src/scss/frontend-vendor.scss")))
